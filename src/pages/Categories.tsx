    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-700 rounded-2xl p-8 mb-12 shadow-lg">
        ...
        <div className="relative">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-white">Browse Categories</h1>
          </div>
          <p className="text-blue-100 max-w-2xl mb-6">
            Explore our wide range of categories and find exactly what you're looking for. Each category features high-quality products at competitive prices.
          </p>
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6">
              ...
              <p className="text-gray-300 mt-2 line-clamp-2 group-hover:text-white transition-colors">
                {category.description || `Explore our collection of ${category.name} products`}
              </p>
      ...
      {filteredCategories.length === 0 && searchTerm && (
        <div className="text-center py-12 bg-gray-50 rounded-xl mt-8">
          ...
          <h3 className="mt-4 text-lg font-medium text-gray-900">No matching categories</h3>
