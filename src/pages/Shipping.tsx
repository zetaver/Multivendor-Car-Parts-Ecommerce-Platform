...
const Shipping = () => {
  ...
  const features = [
    ...
    {
      icon: <Package className="w-6 h-6 text-[#FFB800]" />,
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-[#1E1E2D] py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <Truck className="w-16 h-16 text-[#FFB800] mx-auto mb-4" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h2 className="text-3xl font-bold text-[#1E1E2D] mb-8 text-center">
          Shipping Methods
        </h2>
          ...
          {shippingMethods.map((method, index) => (
            ...
            >
              <div className="flex items-center mb-4">
                {method.icon}
                <h3 className="text-xl font-semibold ml-3 text-[#1E1E2D]">{method.name}</h3>
              </div>
              <div className="space-y-2">
                <p className="text-gray-600">{method.description}</p>
                <p className="font-semibold text-[#FFB800]">{method.price}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-[#1E1E2D]">{feature.title}</h3>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-white rounded-lg shadow-md p-8">
          <div className="flex items-center mb-6">
            <Calculator className="w-8 h-8 text-[#FFB800] mr-3" />
            <h2 className="text-2xl font-bold text-[#1E1E2D]">Shipping Calculator</h2>
          </div>
          <form className="space-y-6">
            <div>
              ...
              <input
                type="text"
                className="w-full px-4 py-2 border rounded-md focus:ring-[#FFB800] focus:border-[#FFB800]"
            ...
            <button
              type="submit"
              className="w-full bg-[#FFB800] text-[#1E1E2D] py-2 px-4 rounded-md hover:bg-[#e6a600] transition-colors font-bold"
            >
              Calculate Shipping
            </button>
          </form>
