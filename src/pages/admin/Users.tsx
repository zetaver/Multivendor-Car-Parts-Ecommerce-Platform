...
const Users = () => {
  ...
  const handleAddUser = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setFormSuccess(t('admin.users.modals.add.success'));
  ...
  const handleUpdateUser = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Show success message
      setEditSuccess(t('admin.users.modals.edit.success'));
  ...
  if (loading && users.length === 0) {
    return <div className="flex justify-center items-center h-64">{t('admin.users.loading')}</div>;
  }
  ...
  return (
    <div>
      ...
      <div className="bg-white shadow rounded-lg overflow-hidden">
        {loading && (
          <div className="p-4 text-center text-gray-500">{t('admin.users.refreshing')}</div>
        )}
                ...
                <tr key={user._id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${
                      ...
                      {user.role === 'user' ? t('admin.users.roles.buyer') : user.role}
                    </span>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
            ...
            <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
              <div>
                <p className="text-sm text-gray-700">
                  {t('admin.users.pagination.showing')} <span className="font-medium">{page}</span> {t('admin.users.pagination.of')}{' '}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-md p-6">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-semibold">{t('admin.users.modals.add.title')}</h2>
              <button 
            ...
            <form onSubmit={handleAddUser}>
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-md"
                  >
                    <option value="user">{t('admin.users.roles.buyer')}</option>
                    <option value="seller">{t('admin.users.roles.seller')}</option>
                    <option value="admin">{t('admin.users.roles.admin')}</option>
                  </select>
                </div>
              ...
              <div className="mt-6 flex justify-end space-x-3">
                ...
                >
                  {t('admin.users.modals.add.submit')}
                </button>
              </div>
            </form>
          </div>
      ...
      {showDeleteModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-md p-6">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-semibold">{t('admin.users.modals.delete.title')}</h2>
              <button 
            ...
            <p className="mb-4">
              {t('admin.users.modals.delete.confirmation')} <span className="font-semibold">{deleteUserName}</span>? 
              {t('admin.users.modals.delete.warning')}
            </p>
            ...
            <div className="mt-6 flex justify-end space-x-3">
              ...
              <button
                ...
                disabled={deleteLoading}
              >
                {deleteLoading ? t('admin.users.modals.delete.deleting') : t('admin.users.modals.delete.submit')}
              </button>
            </div>
          </div>
        </div>
      ...
      {showEditModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-md p-6">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-semibold">{t('admin.users.modals.edit.title')}</h2>
              <button 
            ...
            <form onSubmit={handleUpdateUser}>
              ...
              <div className="mt-6 flex justify-end space-x-3">
                ...
                <button
                  ...
                  disabled={editLoading}
                >
                  {editLoading ? t('admin.users.modals.edit.updating') : t('admin.users.modals.edit.submit')}
                </button>
              </div>
            </form>
          </div>
